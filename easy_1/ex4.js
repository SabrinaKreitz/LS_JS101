...
/*
4. Build a program that asks the user to enter the length and width of a room in meters, 
...
END
*/
// version 1 - without inquiring for entity 

const readline = require('readline-sync');

let length = readline.question("Which length?")
let width = readline.question("Which width?")

    let roomInM2 = length * width; 
    let roomInFeet2 = roomInM2 * 10.7639;
    console.log(roomInM2);
    console.log(roomInFeet2);

    // version 2 - with inquiring for entity 
const readline = require('readline-sync');
